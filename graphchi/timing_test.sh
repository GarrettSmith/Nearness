...
BIN="/home/garrett/dev/maximal_clique/graphchi/bin/maximal_clique"

PREPROCESS="/home/garrett/dev/maximal_clique/graphchi/bin/myapps/preprocess"

ARGS="nshards 1 sort 0"

OUTPUT="$START_DIR/timing_test_graphchi_output"
cat /dev/null > "$OUTPUT"

ITERATIONS=100
TIMEFORMAT='%3R/%3U/%3S'

cd "/home/garrett/dev/maximal_clique/graphchi"
...
do
    ...
    do
        ...
        do
            ...
            rm -rf ${DATA_DIRS[$i]}/InputData.txt_e$e*
    ...
    do
        ...
        do
            ...
            command="$PREPROCESS file ${DATA_DIRS[$i]}/InputData.txt $ARGS features ${FEATURES[$i]} epsilon $e"
            result=`(time $command) 2>&1`
    ...
    do
        ...
        #preprocess
        $("$PREPROCESS"  file "${DATA_DIRS[$i]}"/InputData.txt "$ARGS" features "${FEATURES[$i]}" epsilon "$e")
