...
BIN="/home/garrett/dev/maximal_clique/recursive/bin/maximal_clique"

ARGS="--disable-sorting"
...
cd "/home/garrett/dev/maximal_clique/recursive/"
...
do
    ...
    do
        ...
        do
            command="$BIN $ARGS --features ${FEATURES[$i]} --epsilon $e ${DATA_DIRS[$i]}/InputData.txt"
